...
$(document).ready(function () {
    ...
    $('selectdd').each(function (index, element) {
        var $element = $(this),
            ...
            onChangeSelectric = function (e) {
                ...
                var formLabel = $(e).parents('.form-field').find('label');
...
function showSelectStateField() {
    if (selectCountryField != "") {
        $(selectCountryField).insertAfter(".hiddenCountryForSelectState");
    }
...
function hideSelectStateField() {
    ...
    $('.selectState').addClass('hiddenFormField');
